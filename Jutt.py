...
{W} [{R}+{W}]{W} OWNER   {G}:{Y} NADEEM ABBASI
{W} [{R}+{W}]{W} FB ID   {R}:{Y} NADEEM ALI ABBASI
{W} [{R}+{W}]{W} WHATSAP {R}:{Y} 03361257076
{W} [{R}+{W}]{W} STATUS  {R}:{Y} {status}
{W} [{R}+{W}]{W} VERSION {R}:{Y} {1.0}
{W} [{R}+{W}]{R}<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>++<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>{W}
{W} [{R}+{W}]{P}            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37mJUTT TOOL]\x1b[0m
...
def menu():
			...
			line()
			print(f"{W} [{R}1{W}] {G}FILE CLONING")
			print(f"{W} [{R}2{W}] {G}FILE CREATE MENU")
			print(f"{W} [{R}3{W}] {G}RANDOM NUM CLONING")
			print(f"{W} [{R}4{W}] {G}SEPRATE LINKS FROM FILE")
			print(f"{W} [{R}5{W}] {G}CUT USED LINKS FROM FILE")
			print(f"{W} [{R}6{W}] {G}REMOVE DOUBLE LINKS FROM FILE ")
			print(f"{W} [{R}7{W}] {G}UNBLOCK YOUR IP ADRESS TRY TO UNLOCK")
			print(f"{W} [{R}0{W}] {G}EXIT FROM RANA TOOL {W}[{R}X{W}] {W}")
			line()
			line()
